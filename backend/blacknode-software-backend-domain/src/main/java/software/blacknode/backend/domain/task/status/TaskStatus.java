...
public interface TaskStatus {
	...
	public static final TaskStatus STATUS_IN_PROGRESS = of(
			HUID.fromString("00000000-0000-0000-0000-000000000002"),
			"In Progress",
			"Task is in progress",
			"#E6AE6E"
	);
	...
	public static final TaskStatus STATUS_ON_HOLD = of(
			HUID.fromString("00000000-0000-0000-0000-000000000003"),
			"In Review",
	...
	public static final TaskStatus STATUS_DONE = of(
			HUID.fromString("00000000-0000-0000-0000-000000000004"),
			"DONE",
			"Task is completed",
			"#33C4a8"
	);
