...
@Mappings({
	...
	@Mapping(target = "title", source = "task.meta.name"),
	@Mapping(target = "description", source = "task.meta.description"),
	@Mapping(target = "priority", source = "task.meta.priority"),
	
	@Mapping(target = "beginAtTimestamp", source = "task.meta.beginAtTimestamp"),
	@Mapping(target = "endAtTimestamp", source = "task.meta.endAtTimestamp"),
	
	@Mapping(target = "statusId", source = "task.status.id"),
})
