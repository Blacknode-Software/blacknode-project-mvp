...
public interface TaskPatchMapper extends ResponseMapper<TaskPatchUseCase.Result, TaskPatchResponse> {

	@PatchOperationsMappingRequest
	TaskPatchCommand toCommand(TaskPatchRequest request, UUID channelId);
