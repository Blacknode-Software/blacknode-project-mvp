...
public interface ProjectCreateMapper extends ProjectMapper, RequestMapper<ProjectCreateRequest, ProjectCreateCommand>, ResponseMapper<ProjectCreateUseCase.Result, ProjectCreateResponse> {
