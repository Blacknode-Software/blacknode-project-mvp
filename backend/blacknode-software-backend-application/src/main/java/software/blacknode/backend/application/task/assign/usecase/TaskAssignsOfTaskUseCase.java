...
import software.blacknode.backend.application.task.assign.command.TaskAssignsOfTaskCommand;
import software.blacknode.backend.application.usecase.ResultExecutionUseCase;
import software.blacknode.backend.domain.session.context.holder.SessionContextHolder;

@Service
@RequiredArgsConstructor
public class TaskAssignsOfTaskUseCase implements ResultExecutionUseCase<TaskAssignsOfTaskCommand, TaskAssignsOfTaskUseCase.Result> {
	...
	@Override
	@Transactional
	public Result execute(TaskAssignsOfTaskCommand command) {
